    ...
    <div class="col-lg-5">
        <main class="form-registration">
            ...
            <form action="/register" method="post">
                ...
                <div class="form-floating">
                    <input type="date" class="form-control @error('birthDate') is-invalid @enderror" id="birthDate" name="birthDate" placeholder="Birth Date" required value="{{ old('birthDate') }}">
