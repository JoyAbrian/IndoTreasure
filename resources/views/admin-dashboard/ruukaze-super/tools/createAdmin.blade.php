            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="primary_phone_number" type="tel" placeholder="Enter your phone number" name="primary_phone_number">
                        </div>
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                <label class="small mb-1" for="birthDate">Birthday</label>
                                <input class="form-control" id="birthDate" type="date" name="birthDate" placeholder="Enter your birthday">
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="gender">Gender</label>
                                <input class="form-control" id="gender" type="enum" placeholder="Enter your location" name="gender">
                            </div>
                        </div>
